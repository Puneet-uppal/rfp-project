...
export default function Dashboard() {
  ...
  const stats = [
    { 
      ...
      bgGradient: 'from-slate-50 to-slate-50/30',
    ...
    { 
      ...
      bgGradient: 'from-slate-50/60 to-slate-50/10',
    ...
    <div className="space-y-8 animate-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {stats.map((stat, index) => {
          ...
          <div 
            key={stat.name} 
              className={`group relative bg-gradient-to-br ${stat.bgGradient} rounded-xl border ${stat.borderColor} p-4 hover:border-slate-300 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden animate-in`}
            ...
            >
              ...
              {/* Top accent line */}
              <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-slate-400 via-slate-500 to-slate-400"></div>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="p-2 rounded-lg bg-white/60 backdrop-blur-sm border border-slate-200/30 text-slate-600 shadow-sm group-hover:bg-white/80 group-hover:shadow-md group-hover:scale-110 group-hover:border-slate-300 transition-all duration-300">
                {stat.icon}
              </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-slate-700 rounded-xl shadow-md">
            ...
            <div className="space-y-4">
              {evaluatingRfps.length > 0 && (
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-slate-50 to-slate-50/50 border border-slate-100/50">
              ...
              {pendingVendorCount > 0 && (
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-slate-50/80 to-slate-50/30 border border-slate-100/40">
                  <div className="p-2 bg-slate-100 rounded-lg">
                    <svg className="w-4 h-4 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
              ...
              {highestBudgetRfp && highestBudgetRfp.budget && (
                <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-slate-50/60 to-slate-50/20 border border-slate-100/30">
                  <div className="p-2 bg-slate-100 rounded-lg">
                    <svg className="w-4 h-4 text-slate-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      ...
      <div className="bg-white rounded-2xl border border-gray-200/80 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 bg-gray-50/50">
          <div className="flex items-center justify-between">
            ...
            <Link 
              to="/rfps" 
              className="text-sm text-slate-600 hover:text-slate-700 font-semibold transition-colors inline-flex items-center gap-1.5"
            >
              View all
