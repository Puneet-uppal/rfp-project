      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
              <div className="w-12 h-12 border-3 border-gray-200 border-t-primary-800 rounded-full animate-spin"></div>
              <div className="absolute inset-0 w-12 h-12 border-3 border-transparent border-r-primary-600 rounded-full animate-spin" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
          </div>
  ...
  const stats = [
    { 
      ...
      icon: (
        ...
        bgGradient: 'from-primary-50 to-primary-50/30',
    ...
    { 
      ...
      icon: (
        ...
        bgGradient: 'from-primary-50/80 to-primary-50/20',
        borderColor: 'border-primary-200/40',
    },
    { 
      ...
      icon: (
        ...
        bgGradient: 'from-primary-50/60 to-primary-50/10',
  ...
  return (
    <div className="space-y-8 animate-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Link
          to="/rfps/create"
            className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-primary-800 text-white text-sm font-semibold rounded-xl hover:bg-primary-900 transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {stats.map((stat, index) => {
          ...
          <div 
            key={stat.name} 
                className={`group relative bg-gradient-to-br ${stat.bgGradient} rounded-xl border ${stat.borderColor} p-4 hover:border-primary-300 hover:shadow-lg transition-all duration-300 hover:-translate-y-1 overflow-hidden animate-in`}
            ...
            >
              ...
              {/* Top accent line */}
                <div className="absolute top-0 left-0 right-0 h-0.5 bg-gradient-to-r from-primary-400 via-primary-600 to-primary-400"></div>
              ...
              <div className="relative">
                ...
                <div className="flex items-center justify-between gap-3">
                    <div className="p-2 rounded-lg bg-white/60 backdrop-blur-sm border border-primary-200/30 text-primary-900 shadow-sm group-hover:bg-white/80 group-hover:shadow-md group-hover:scale-110 group-hover:border-primary-300 transition-all duration-300">
                {stat.icon}
              </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="p-2.5 bg-primary-900 rounded-xl shadow-md">
            ...
            <div className="space-y-4">
              {evaluatingRfps.length > 0 && (
                 <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-primary-50 to-primary-50/50 border border-primary-100/50">
                   <div className="p-2 bg-primary-100 rounded-lg">
                     <svg className="w-4 h-4 text-primary-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              ...
              {pendingVendorCount > 0 && (
                 <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-primary-50/80 to-primary-50/30 border border-primary-100/40">
                   <div className="p-2 bg-primary-100 rounded-lg">
                     <svg className="w-4 h-4 text-primary-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
              ...
              {highestBudgetRfp && highestBudgetRfp.budget && (
                 <div className="flex items-start gap-4 p-4 rounded-xl bg-gradient-to-r from-primary-50/60 to-primary-50/20 border border-primary-100/30">
                   <div className="p-2 bg-primary-100 rounded-lg">
                     <svg className="w-4 h-4 text-primary-900" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gray-50/50">
          <div className="flex items-center justify-between">
            <div>
              ...
              <Link 
                to="/rfps" 
                className="text-sm text-primary-900 hover:text-primary-950 font-semibold transition-colors inline-flex items-center gap-1.5"
            >
              View all
