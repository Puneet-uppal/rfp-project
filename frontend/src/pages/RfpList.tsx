    ...
    <div className="space-y-8 animate-in">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <select
          ...
          className="px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm text-gray-900 bg-white transition-all hover:border-gray-400 cursor-pointer font-medium"
        >
