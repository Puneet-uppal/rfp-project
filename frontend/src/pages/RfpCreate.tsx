    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in">
      ...
      {!parsedRfp ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <button
                ...
                className="bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center gap-2 shadow-lg hover:shadow-xl"
              >
              {isProcessing ? (
                <>
              ...
              {examplePrompts.map((prompt, index) => (
                ...
                >
                  <span className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 rounded-full bg-gray-100 group-hover:bg-blue-100 flex items-center justify-center text-gray-400 group-hover:text-blue-700 transition-colors">
                      {index + 1}
                    </span>
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-blue-50 to-blue-50/50 border border-blue-200 rounded-xl p-4 flex items-center gap-3">
            ...
            <div>
              <p className="text-blue-700 font-semibold">RFP Generated Successfully</p>
              <p className="text-blue-600 text-sm">Review the details below and confirm to proceed</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-6 shadow-sm">
            ...
            {parsedRfp.aiSummary && (
              <div className="bg-gradient-to-r from-blue-50 to-blue-50/50 p-4 rounded-lg border border-blue-100">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-5 border-t">
              {parsedRfp.budget && (
                <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-50/50 rounded-lg border border-blue-100">
                  <p className="text-xs font-medium text-blue-600 uppercase tracking-wide mb-1">Budget</p>
                  <p className="font-bold text-blue-700 text-lg">{parsedRfp.currency || ''} {parsedRfp.budget.toLocaleString()}</p>
                </div>
              )}
                ...
                {parsedRfp.items.map((item, index) => (
                  <div key={index} className="group border border-gray-100 rounded-lg p-4 bg-gradient-to-br from-gray-50 to-white hover:border-blue-200 hover:shadow-sm transition-all duration-200">
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex items-start gap-3">
                        <span className="flex items-center justify-center w-7 h-7 rounded-full bg-blue-100 text-blue-700 font-semibold text-sm flex-shrink-0">
                          {index + 1}
                        </span>
                        <div>
                      ...
                      <span className="inline-flex items-center px-3 py-1.5 bg-blue-50 text-blue-700 rounded-lg font-medium text-sm border border-blue-100">
                        Qty: {item.quantity}
                      </span>
                    </div>
                  </div>
